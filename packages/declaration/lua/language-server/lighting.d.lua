...
---
--- Lighting, a static global class, is the in-game light of the map. It allows you to modify the lighting of the instance in the same way that the [in-game lighting menu](https://kb.tabletopsimulator.com/host-guides/lighting/) does. You call these functions like this: [`Lighting.apply()`](lua://tts.Lighting.apply).
---
...
---@alias tts.Lighting.AmbientType
---| 1 Background
---| 2 Gradient
