 ...
 * instance in the same way that the in-game lighting menu does. You call these functions like this: Lighting.apply().
 *
 * For more information on lighting in Unity, refer to the Unity documentation.
 */
/** @noSelf */
declare class TTSLighting {
    ...
    /**
     * Returns Color Table of the gradient equator. Not used if ambient type is Background.
     */
    getAmbientEquatorColor(): Color;

    /**
     * Returns Color Table of the gradient ground. Not used if ambient type is Background.
     */
    getAmbientGroundColor(): Color;

    /**
     * Returns Color Table of the gradient sky. Not used if ambient type is Background.
     */
    ...
    /**
     * Sets the color of the gradient equator. Not used if ambient type is Background.
     *
    ...
    /**
     * Sets the color of the gradient ground. Not used if ambient type is Background.
     *
     * @param color The new color.
     */
    ...
    /**
     * Sets the color of the gradient sky. Not used if ambient type is Background.
     *
     * @param color The new color.
     */
...
declare const Lighting: TTSLighting;
