 ...
 * @param keepOpen Keep context menu open after menu item was selected. Optional, Default false. Close context menu
 *                 after selection.
 * @param requireTable Show added menu item when right-clicked on empty space or table. Optional, Default false. Show
 ...
 * decks/stacks formed. Not all objects CAN be grouped. If the G key won't work on them, neither will this function.
 *
 ...
 * This API gives you complete control over all persistent properties that an object has.
 *
 * Unless you've already got an object's JSON representation at your disposal then spawnObjectData(...) is the preferred
 * API as it's less resource intensive.
 *
 * Objects take a moment to spawn. The purpose of callback_function is to allow you to execute additional code after the
 * object has finished spawning.
 *
 * @param parameters json is mandatory, all other properties are optional. When a property is omitted, it will be given
 *                   the corresponding default value (above).
 *
 * @example
 *
 ...
 * @param hoveredObject The object that the Player's pointer was hovering over at the moment the key was
 ...
 * Therefore addHotkey(...) needs to be called each time the game is loaded. As long as the same labels are used, then
 * player hotkey bindings will persist.
 *
 ...
 * @param callback The function that will be executed whenever the hotkey is pressed, and also when released if
 *                 triggerOnKeyUp is true.
 * @param triggerOnKeyUp Whether the callback is also executed when the hotkey is released. The callback is always
 *                       triggered when the hotkey is pressed. Optional, defaults to false.
 *
 * @example
 *
 * ```lua
 ...
 *
 * If value is a , then the table's contents (keys & values) will be displayed. The contents of nested tables will also
 * be displayed up to a user-configurable depth.
 *
 * Tip
 * ---
 *
 ...
 * provided as the tags parameter. The message style will be taken from the first tag that the user has not explicitly disabled.
 *
 ...
 * @param tags The log tag/style or a space separated list of log tags/styles. (See: logStyle(...)) Optional, defaults
 ...
 * If value is not already a string, then it will be converted to a human-readable representation.
 *
 * If value is a table, then the table's contents (keys & values) will be included in the resultant String. The contents
 * of nested tables will also be displayed up to a user-configurable depth.
 *
 * Tip
 * ---
 *
 ...
 * @param value The value you want to log.
 * @param label Text to be logged before value. Optional, defaults to an empty String. Empty Strings are not displayed.
 * @param tags The log tag/style or a space separated list of log tags/styles. Optional, defaults to logging without any
 *             tags.
 * @param concise Whether the resultant String should be generated in a more compact form (less newline characters).
 *                Optional, defaults to `false`.
 * @param displayTag Whether the specified tag(s) should be included as prefix of the resultant String. Optional,
 *                   defaults to `false`.
 *
 * @example
 *
 ...
 * @param prefix Text to place before this type of log entry. Optional, defaults to an empty String. Empty Strings are
 *               not displayed.
 * @param postfix Text to place after this type of log entry. Optional, defaults to an empty String. Empty Strings are
 *                not displayed.
 *
 * @example
 *
